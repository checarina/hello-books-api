...
def test_get_all_books_with_some_records(client, two_saved_books):
    response = client.get("/books")
    response_body = response.get_json()
...
def test_get_one_book_not_found(client, two_saved_books):
...
def test_get_one_model_id_invalid(client, two_saved_books):
    # Act
...
def test_validate_model(two_saved_books):
    ...
    assert result_book.description == "water"
